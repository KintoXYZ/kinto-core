    ...
    function run() public override {
        ...
        _handleOps(
            abi.encodeWithSelector(
                BridgedToken.burn.selector, _getChainDeployment("RewardsDistributor"), total + 3797040
            ),
        ...
        require(
            kintoToken.balanceOf(records[records.length - 1].user) == balances[records.length - 1] + 1604278075000000000,
            "Did not burn"
        );
