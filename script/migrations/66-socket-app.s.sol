...
contract KintoMigration66DeployScript is MigrationHelper {
    ...
    function run() public override {
        ...
        // tokens
        appContracts[13] = _getChainDeployment("DAI");
        appContracts[24] = _getChainDeployment("wstETH");
        appContracts[14] = _getChainDeployment("WETH");
        appContracts[15] = _getChainDeployment("USDC");
        appContracts[16] = _getChainDeployment("ENA");
        appContracts[17] = _getChainDeployment("USDe");
        appContracts[18] = _getChainDeployment("EIGEN");
        appContracts[19] = _getChainDeployment("eETH");
        appContracts[20] = _getChainDeployment("sDAI");
        appContracts[21] = _getChainDeployment("sUSDe");
        appContracts[22] = _getChainDeployment("wUSDM");
        ...
        kintoAppRegistry.registerApp("Socket", parentContract, appContracts, appLimits);
    }
}
