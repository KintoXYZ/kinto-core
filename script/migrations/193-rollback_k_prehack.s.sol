...
contract FixKintoPreHack is MigrationHelper {
    ...
    function run() public override {
        ...
        require(kintoToken.balanceOf(records[1].user) == balances[1] - 1210749128446640000, "Did not burn 1 ");
        require(kintoToken.balanceOf(records[2].user) == balances[2] - 438250747191611000, "Did not burn 2");
        // require(
